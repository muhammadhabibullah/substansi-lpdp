...
const id = {
  ...
  setup: {
    ...
    parsedOk: '{chars} karakter diekstrak dari {pages} halaman',
    parsedOkNoPages: '{chars} karakter diekstrak',
...
const en: Copy = {
  ...
  setup: {
    ...
    parsedOk: '{chars} characters extracted from {pages} pages',
    parsedOkNoPages: '{chars} characters extracted',
